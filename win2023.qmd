...
format: 
  revealjs:
    ...
    width: 1050
    height: 700
    footer: WIN · 27 Sept 2023 · CBS Heerlen
editor: visual
---
...
## Travel Diary App {.section background-image="backgrounds/bend.png" visibility="hidden"}

::: footer
:::

###  {data-background-video="images/tour_video_transportmode_nl.mp4" data-background-size="contain" visibility="hidden"}

::: footer
:::

### Using the data like a travel survey {background-image="backgrounds/twistright.png" visibility="hidden"}
...
### Data from the app 2 {data-background="backgrounds/linestogether.png"}
